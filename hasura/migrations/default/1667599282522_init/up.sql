...
CREATE INDEX recurring_active_ix1 ON public.recurring USING btree (active);
CREATE INDEX recurring_labels_ix1 ON public.recurring_labels USING btree (recurring_id);
CREATE INDEX transaction_date_ix1 ON public.transactions USING brin (transaction_date);
CREATE INDEX transaction_recurring_ix1 ON public.transactions USING btree (recurring_id);
...
ALTER TABLE ONLY public.transaction_accounts
    ADD CONSTRAINT transaction_accounts_transaction_id_fkey FOREIGN KEY (transaction_id) REFERENCES public.transactions(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY public.transaction_attachments
...
ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_account_from_fkey FOREIGN KEY (account_from) REFERENCES public.account_info(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_account_to_fkey FOREIGN KEY (account_to) REFERENCES public.account_info(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.transactions
